...
Usage:
  python pcap_to_flows_advanced_timeout.py input.pcap output.csv \
...
class Flow:
    ...
    def to_row(self) -> dict:
        ...
        return {
            ...
            # IAT (overall + directional) — counts removed by request
...
def pcap_to_flows(pcap_path: str,
    ...
    fieldnames = [
        ...
        # IAT stats (overall + dir) — counts removed by request
        "IATMin", "IATMax", "IATMean", "IATStd",
        "FwdIATMin", "FwdIATMax", "FwdIATMean", "FwdIATStd",
        "BwdIATMin", "BwdIATMax", "BwdIATMean", "BwdIATStd",
        # TCP flags
